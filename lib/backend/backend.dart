...
import 'schema/filename_record.dart';
...
export 'schema/filename_record.dart';
...
/// Functions to query FilenameRecords (as a Stream and as a Future).
Future<int> queryFilenameRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      FilenameRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<FilenameRecord>> queryFilenameRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      FilenameRecord.collection,
      FilenameRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<FilenameRecord>> queryFilenameRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
